...
while not last_inst_write_back:
	...
	WB_message, last_inst_write_back = WB(MEM3_WB_reg, last_ins_num, last_inst_write_back)
	...
	IF1_message, IF1_IF2_reg, PC, IF1_IF2_changed, last_inst_read_flag = IF1(PC, 
		last_ins_num, last_inst_read_flag, IF1_IF2_changed, branch_flag)
